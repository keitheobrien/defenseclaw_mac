...
The app is checked feature-for-feature against the DefenseClaw 0.8.9 runtime contract, with an adversarial review pass over each area. Highlights of the shared semantics:
