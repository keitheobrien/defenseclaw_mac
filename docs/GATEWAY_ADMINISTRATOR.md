...
Administrator mode gives Runtime monitoring the permissions needed to observe activity across the machine. It is off by default and requires a signed installation of DefenseClawMac. Unsigned development builds cannot use this mode.
